...
node --experimental-default-type=module --test tests/audioMixer.test.mjs src/workspace/navigation.test.mjs src/demo/sceneImages.test.mjs src/utils/voiceGroups.test.mjs src/utils/timelineEditing.test.mjs src/utils/scriptAudit.test.mjs
