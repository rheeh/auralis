...
KNOWLEDGE_ARTICLE_ENABLED = _env_bool("KNOWLEDGE_ARTICLE_ENABLED", True)
KNOWLEDGE_ARTICLE_URL_ENABLED = _env_bool("KNOWLEDGE_ARTICLE_URL_ENABLED", True)
KNOWLEDGE_ARTICLE_EXTERNAL_VERIFY_ENABLED = _env_bool("KNOWLEDGE_ARTICLE_EXTERNAL_VERIFY_ENABLED", False)
KNOWLEDGE_ARTICLE_VISION_ENABLED = _env_bool("KNOWLEDGE_ARTICLE_VISION_ENABLED", False)
