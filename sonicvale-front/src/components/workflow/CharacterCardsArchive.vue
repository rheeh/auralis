...
<style scoped>
.character-archive{display:grid;gap:14px}.character-archive header{display:flex;align-items:center;justify-content:space-between}.character-archive h3,.eyebrow{margin:0}.eyebrow{color:var(--el-color-primary);font-size:11px}.character-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:12px}.character-grid article{display:grid;grid-template-columns:auto minmax(0,1fr);gap:12px;padding:14px;border:1px solid color-mix(in srgb,var(--role-color) 42%,var(--el-border-color));border-top:4px solid var(--role-color);border-radius:14px;background:var(--el-bg-color)}.character-grid .el-avatar{background:color-mix(in srgb,var(--role-color) 18%,var(--el-fill-color));border:2px solid color-mix(in srgb,var(--role-color) 54%,white)}.copy strong,.copy small{display:block}.copy small,.copy p,.tags span{color:var(--el-text-color-secondary)}.copy p{margin:6px 0 0;line-height:1.5}.tags{grid-column:1/-1;display:flex;align-items:center;justify-content:space-between;gap:8px;font-size:12px}
