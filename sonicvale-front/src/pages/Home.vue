    ...
    <section class="hero-shell">
      <header class="landing-nav enter-nav">
        ...
        <nav aria-label="首页导航">
          ...
          <RouterLink to="/projects?create=choose">创作</RouterLink>
        ...
        <div class="nav-actions">
          ...
          <RouterLink class="nav-primary" to="/projects?create=choose">开始创作</RouterLink>
        </div>
      </header>

      <div id="hero" class="hero-content">
        <div class="hero-copy">
          <p class="product-kicker enter-title">AI AUDIO CONTENT STUDIO</p>
          <h1 class="enter-title">Auralis</h1>
          <p class="cn-title enter-subtitle">广 播 剧 · 知 识 音 频</p>
          <div class="creation-choices enter-actions" aria-label="选择创作类型">
            <RouterLink class="creation-choice drama-choice" to="/projects?create=novel">
              <span class="choice-mark" aria-hidden="true">剧</span>
          ...
          <div class="hero-actions enter-actions">
            <RouterLink class="start-button" to="/projects"><span>▦</span>查看项目</RouterLink>
...
.hero-content{position:relative;z-index:3;min-height:calc(100vh - 258px)}.hero-copy{position:relative;z-index:9;width:min(610px,48vw);padding:6vh 0 104px 7vw}.product-kicker{margin:0 0 16px;color:#75869a;font-size:11px;letter-spacing:.28em}.hero-copy h1{margin:0;font-family:Georgia,"Times New Roman",serif;font-size:clamp(78px,8vw,142px);font-weight:400;line-height:.78;letter-spacing:-.06em}.cn-title{margin:25px 0 0;font-size:22px;letter-spacing:.3em}.hero-description{max-width:460px;margin:24px 0 0;color:#5a6c7e;font-size:14px;line-height:1.8}.creation-choices{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px;margin-top:28px}.creation-choice{position:relative;display:grid;grid-template-columns:42px minmax(0,1fr) 18px;gap:11px;align-items:center;min-height:78px;padding:11px 13px;border:1px solid rgba(117,151,182,.2);border-radius:18px;color:#18324f;text-decoration:none;background:rgba(255,255,255,.62);box-shadow:0 12px 30px rgba(50,78,103,.09);backdrop-filter:blur(15px);transition:transform .2s ease,border-color .2s ease,box-shadow .2s ease}.creation-choice:hover{transform:translateY(-3px);border-color:rgba(65,145,194,.45);box-shadow:0 18px 36px rgba(48,84,114,.15)}.choice-mark{display:grid;width:42px;height:42px;place-items:center;border-radius:13px;color:#217ca2;background:linear-gradient(145deg,#ddf3fc,#e7efff);font-size:15px;font-weight:800}.creation-choice>span:nth-child(2){display:grid;gap:2px;min-width:0}.creation-choice small{color:#74869a;font-size:9px;letter-spacing:.1em;text-transform:uppercase}.creation-choice strong{font-size:14px}.creation-choice em{overflow:hidden;color:#718195;font-size:10px;font-style:normal;text-overflow:ellipsis;white-space:nowrap}.creation-choice b{color:#60758b;font-size:17px;transition:transform .2s ease}.creation-choice:hover b{transform:translateX(3px)}.knowledge-choice{border-color:rgba(117,111,200,.2);background:linear-gradient(135deg,rgba(244,243,255,.78),rgba(240,254,251,.68))}.knowledge-choice .choice-mark{color:#5d57b9;background:linear-gradient(145deg,#e9e7ff,#dff6f2)}.hero-actions{display:flex;gap:14px;margin-top:18px}.start-button,.demo-button{display:flex;align-items:center;justify-content:center;gap:11px;height:48px;padding:0 25px;border:0;border-radius:24px;box-sizing:border-box;text-decoration:none;font-size:13px;transition:transform .18s ease,box-shadow .18s ease}.start-button{color:#fff;background:linear-gradient(135deg,#486584,#071f3c);box-shadow:0 16px 30px rgba(24,50,79,.22)}.start-button:hover{transform:translateY(-2px);box-shadow:0 17px 36px rgba(30,67,106,.32),0 0 24px rgba(150,195,230,.28)}.start-button:active,.demo-button:active{transform:scale(.97)}.demo-button{cursor:pointer;color:#26384a;background:rgba(255,255,255,.68);box-shadow:0 10px 28px rgba(65,82,100,.1),inset 0 0 0 1px rgba(255,255,255,.92)}.demo-button:hover{transform:translateY(-2px)}.button-icon{display:grid;place-items:center;width:25px;height:25px;border-radius:50%;font-size:10px;background:rgba(255,255,255,.8)}
...
@media(max-width:1100px){.landing-nav{grid-template-columns:180px 1fr 180px;padding:0 28px}.landing-nav nav{gap:22px}.hero-copy{width:52vw;padding-left:5vw}.creation-choices{grid-template-columns:1fr;max-width:330px}.creation-choice{min-height:66px}.continue-card{display:none}.feature-strip{gap:12px;padding-inline:3vw}.feature-strip a{padding:0 15px}.ring-system{right:-2vw}.listener-silhouette{right:calc(-2vw + min(56vw,700px)/2 - 90px)}}
@media(max-width:760px){.landing-page{padding:0}.hero-shell{min-height:940px;border-radius:0}.landing-nav{display:flex;justify-content:space-between;padding:0 20px}.landing-nav nav,.ghost-link{display:none}.landing-brand{font-size:21px}.hero-content{min-height:860px}.hero-copy{width:auto;padding:58px 24px 410px}.hero-copy h1{font-size:76px}.cn-title{font-size:17px;letter-spacing:.2em}.creation-choices{max-width:none;margin-top:24px}.hero-actions{gap:10px}.start-button,.demo-button{height:48px;padding:0 20px}.ring-system{right:50%;top:72%;width:480px;translate:50% -50%}.listener-silhouette{right:calc(50% - 70px);top:58%;width:140px;height:280px}.particle-field{right:0;top:48%;width:100%;height:46%}.wave-canvas{top:65%;height:18%}.explore-link{display:none}.feature-strip{grid-template-columns:1fr;padding:18px}.feature-strip a{min-height:78px}.nav-primary{min-width:94px}.hero-description{font-size:13px}}
